...
LOCK TABLES `boostack_http_session` WRITE;
/*!40000 ALTER TABLE `boostack_http_session` DISABLE KEYS */;

INSERT INTO `boostack_http_session` (`id`, `ascii_session_id`, `logged_in`, `user_id`, `last_impression`, `created`, `user_agent`)
VALUES
	(0,'63ba8fbe76ed2444f5df950a0a94aecc','f',0,1448891197,1448891197,'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/601.2.7 (KHTML, like Gecko) Version/9.0.1 Safari/601.2.7');

/*!40000 ALTER TABLE `boostack_http_session` ENABLE KEYS */;
UNLOCK TABLES;
