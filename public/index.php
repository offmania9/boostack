...
function initRoutes(): Router
{
    ...
    $router->addRoute('documentation', [My\Controllers\Documentation::class, 'init']);
    $router->addRoute('docs', [My\Controllers\Documentation::class, 'init']);
    $router->addRoute('documentation/(\d{1,3}(?:\.[\dx]{1,3}){0,2})/([a-zA-Z0-9_-]+)', [My\Controllers\Documentation::class, 'init'], HttpMethod::GET, ['version', 'docpath']);
    $router->addRoute('documentation/(\d{1,3}(?:\.[\dx]{1,3}){0,2})', [My\Controllers\Documentation::class, 'init'], HttpMethod::GET, ['version']);
