...
$config["url_logo"] = "img/boostack_logo_x210.png";
$config["url_logo_dark"] = "img/boostack_logo_x210.png";
...
$config["site_shortcuticon"] = "img/favicon.ico";
$config["appletouchicon_144"] = "img/apple-touch-icon-144-precomposed.png";
$config["appletouchicon_114"] = "img/apple-touch-icon-114-precomposed.png";
$config["appletouchicon_72"] = "img/apple-touch-icon-72-precomposed.png";
$config["appletouchicon_def"] = "img/apple-touch-icon-57-precomposed.png";
